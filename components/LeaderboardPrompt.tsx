  ...
  return (
    <div className="mb-6 rounded-2xl border-2 border-brand-navy bg-white p-5">
      ...
      <p className="mb-4 text-sm text-brand-navy/60">
        Enter your name and email to track your stats. Complete{' '}
        <span className="font-semibold text-brand-navy">1 session</span> (10 answers) to appear in the rankings.
      </p>
